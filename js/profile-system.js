                ...
                <div style="margin-bottom: 20px;">
                    <img src="${photoSrc}" 
                         ...
                         style="
                            ...
                            margin-bottom: 15px;
                         "
                         onerror="this.src='./nexlify-logo.jpg'">
                </div>
            ...
            links.push(`
                <a href="${associate.linkedin}" target="_blank" rel="noopener noreferrer" 
                   ...
                   style="
                        ...
                        height: 44px;
                   "
                   onmouseover="this.style.background='#005885'; this.style.transform='translateY(-2px) scale(1.1)'"
                   onmouseout="this.style.background='#0077B5'; this.style.transform='translateY(0) scale(1)'">
            ...
            links.push(`
                <a href="${associate.whatsapp}" target="_blank" rel="noopener noreferrer"
                   ...
                   style="
                        ...
                        height: 44px;
                   "
                   onmouseover="this.style.background='#1eb757'; this.style.transform='translateY(-2px) scale(1.1)'"
                   onmouseout="this.style.background='#25D366'; this.style.transform='translateY(0) scale(1)'">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            links.push(`
                <a href="${associate.x}" target="_blank" rel="noopener noreferrer"
                   ...
                   style="
                        ...
                        height: 44px;
                   "
                   onmouseover="this.style.background='#333333'; this.style.transform='translateY(-2px) scale(1.1)'"
                   onmouseout="this.style.background='#000000'; this.style.transform='translateY(0) scale(1)'">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
