            ...
            links.push(`
                <a href="${associate.linkedin}" target="_blank" rel="noopener noreferrer" 
                   style="
                        ...
                        font-weight: 500;
                   "
                   onmouseover="this.style.background='#005885'; this.style.transform='translateY(-2px)'"
            ...
            links.push(`
                <a href="${associate.whatsapp}" target="_blank" rel="noopener noreferrer"
                   style="
                        ...
                        font-weight: 500;
                   "
                   onmouseover="this.style.background='#1eb757'; this.style.transform='translateY(-2px)'"
